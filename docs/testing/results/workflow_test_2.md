...
- 候选人"李四"匹配度为75%，匹配理由为"候选人有相关产品经验，但行业背景不完全匹配"

### 3. 面试安排
- 在匹配结果中找到候选人"李四"
- 点击"安排面试"按钮，跳转到面试安排页面
- 填写面试信息：
  - 面试时间：2025-03-06 10:00
  - 面试官：王经理
  - 面试形式：产品面试
  - 面试地点：公司会议室B
- 点击提交按钮
...
## 测试总结
产品岗位招聘流程的基本功能已通过模拟数据实现，可以进行基本的操作和流程测试。但由于后端API集成问题，某些功能可能无法与后端系统正常交互。建议在修复后端API问题后重新进行完整测试。
